...
//    [_messageContent setBubbleSide:isRecive];
    ...
    [_headView setFrame:CGRectMake(VERTICAL_SCREEN_WIDTH - headHeight - gapWidth, 0, headHeight, headHeight)];//头像位置
//    [_messageContent setBubbleSide:isRecive];
    [_messageContent setFrame:CGRectMake(VERTICAL_SCREEN_WIDTH - headHeight - 5 - contentSize.width, 0, contentSize.width, contentSize.height)];
...
- (void)reSendMessage {//重发消息
    ...
    [[WHAlertTool shareInstance]showAlterViewWithMessage:@"" andDoneBlock:^(UIAlertAction * _Nonnull action) {
