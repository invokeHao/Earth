...
- (instancetype)init {
    return [self initWithType:AlignWithCenter betweenOfCell:12.0];
}
...
- (instancetype)initWthType:(AlignType)cellType {
    return [self initWithType:cellType betweenOfCell:12.0];
}
