...
- (UIView *(^)(NSString *))WH_backgroundColor{
    return ^(NSString *string){
        if ([string isKindOfClass:[NSString class]]) {
            self.backgroundColor = wh_colorWithHexString(string);
...
- (UILabel *(^)(UIFont *))WH_font{
    return ^(UIFont *font) {
        if ([font isKindOfClass:[UIFont class]]) {
            ...
            self.font = WHFont([(NSString *)font floatValue]);
        }
        else if ([font isKindOfClass:[NSNumber class]]) {
            self.font = WHFont([(NSNumber *)font floatValue]);
        }
        return self;
    };
}
...
- (UILabel *(^)(UIColor *))WH_textColor{
    return ^(UIColor *color){
        if ([color isKindOfClass:[UIColor class]]) {
            ...
            self.textColor = wh_colorWithHexString((NSString*)color);
        }
        return self;
    };
}
...
- (UILabel *(^)(UIColor *))WH_shadowColor{
    return ^(UIColor *color) {
        if ([color isKindOfClass:[UIColor class]]) {
            ...
            self.shadowColor = wh_colorWithHexString((NSString*)color);
        }
        return self;
    };
}
...
- (UIButton *(^)(UIColor *))WH_tintColor{
    return ^(UIColor *tintColor) {
        if ([tintColor isKindOfClass:[UIColor class]]) {
            ...
            self.tintColor = wh_colorWithHexString((NSString *)tintColor);
        }
        return self;
    };
}
...
- (UIButton *(^)(UIFont *))WH_titleLabel_font{
    return ^(UIFont *font) {
        if ([font isKindOfClass:[UIFont class]]) {
            ...
            self.titleLabel.font = WHFont([(NSString *)font floatValue]);
        }else if ([font isKindOfClass:[NSNumber class]]) {
            self.titleLabel.font = WHFont([(NSNumber *)font floatValue]);
        }
        return self;
    };
}
...
- (UIImageView *(^)(UIColor *))WH_tintColor{
    return ^(UIColor *color){
        if ([color isKindOfClass:[UIColor class]]) {
            ...
            self.tintColor = wh_colorWithHexString((NSString *)color);
        }
        return self;
    };
}
...
- (UITextField *(^)(UIColor *))WH_textColor{
    return ^(UIColor *textColor) {
        if ([textColor isKindOfClass:[UIColor class]]) {
            ...
            self.textColor = wh_colorWithHexString((NSString*)textColor);
        }
        return self;
    };
}
