...
- (instancetype)initWithTargetView:(UIView *)view {
    ...
    if (self) {
        ...
        _hud.bezelView.color = [UIColor wh_colorWithHexString:@"#050506" alpha:0.4];
...
+ (void)showString:(NSString *)string hideDelay:(NSTimeInterval)time offsetY:(CGFloat)offsetY {
    ...
    if (window) {
        ...
        hud.bezelView.color = [UIColor wh_colorWithHexString:@"#050506" alpha:0.4];
